 ...
 * 
 * 1. HTTP 응답을 세밀하게 제어하기 위한 클래스이다
 * 2. HTTP 상태 코드, 응답 헤더, 응답 본문을 포함할 수 있어 REST API 응답을 명호가하고 유연하게 처리할 수 있다
 * 3. 생성자 및 빌더 패턴을 지원해 다양한 방법으로 코드를 작성할 수 있다
 * 
 * */
...
public class AsyncControllerC {
  ...
  public ResponseEntity<BoardDTO> methodA(@RequestParam int bid) {
